        ...
        <tbody>
            ...
            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                <tr>
                    ...
                    <td>
                        <?php if ($row['photo']): ?>
                            <img src="img/<?= htmlspecialchars($row['photo']) ?>" width="50" height="50">
                        <?php endif; ?>
                    </td>
                    <td>
                        <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#editUserModal<?= $row['id'] ?>">Edit</button>
    ...
    <nav>
        <ul class="pagination justify-content-center">
            <?php if ($current_page > 1): ?>
                <li class="page-item">
                    <a class="page-link" href="?page=user&page_number=<?= $current_page - 1 ?>">Previous</a>
                </li>
            <?php endif; ?>
            ...
            <?php if ($current_page < $total_pages): ?>
                <li class="page-item">
                    <a class="page-link" href="?page=user&page_number=<?= $current_page + 1 ?>">Next</a>
                </li>
            <?php endif; ?>
        </ul>
 </nav>
